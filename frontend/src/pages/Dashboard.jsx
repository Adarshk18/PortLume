...
export default function Dashboard() {
  ...
  const checklist = [
    ...
    { text: "Projects Added", checked: (portfolio.projects?.length || 0) > 0 },
    {
      ...
      checked: portfolio.portfolioPublished || false,
    },
  ];
          ...
          >
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                >
                  Portfolio Status:{" "}
                  {portfolio.portfolioPublished ? "Published" : "Draft"}
                </span>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-xl border border-slate-200/50 p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-sm text-slate-500">
                    {portfolio.projects?.length || 0} repos
                  </span>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {portfolio.projects && portfolio.projects.length > 0 ? (
                    ...
                    <div className="col-span-2 text-center py-8 text-slate-500">
                      <p>
                        No projects yet. Click "Sync GitHub Now" to import your
                        repos!
                      </p>
                    </div>
                  )}
              ...
              {portfolio.about && (
                <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-xl border border-slate-200/50 p-6">
                  ...
                  <button
                    ...
                    className="mt-4 text-sm text-purple-600 hover:text-purple-700 font-medium flex items-center gap-2"
                  >
                    {generatingAI ? (
            ...
            <div className="space-y-6">
              ...
              >
                ...
                {portfolio.portfolioPublished && portfolio.publicUrl ? (
                  <>
                    <div className="text-sm text-slate-600 mb-4 break-all">
                      {window.location.origin}/u/{portfolio.publicUrl}
                    </div>
                    ...
                    <a
                      href={`/u/${portfolio.publicUrl}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full px-4 py-2 bg-emerald-100 text-emerald-700 rounded-lg text-sm font-medium hover:bg-emerald-200 transition flex items-center justify-center gap-2"
                    >
                  ...
                  <div className="text-center py-6">
                    ...
                    <p className="text-xs text-slate-400">
                      Enter a username above and click "Publish Now"
                    </p>
                  </div>
                )}
              </motion.div>
              ...
              >
                ...
                <div className="text-sm">
                  Complete all checklist items to unlock your full portfolio potential!
                </div>
              </motion.div>
            </div>
          </div>
